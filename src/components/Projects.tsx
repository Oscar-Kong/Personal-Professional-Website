    ...
    <section id="projects" className="py-20 bg-slate-50">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
            ...
            {featuredProjects.map((project, index) => (
              <div key={index} className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group">
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4 p-2 bg-white/20 backdrop-blur-sm rounded-full text-white">
                    {project.icon}
                  </div>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <a 
                      ...
                      className="flex items-center gap-2 px-4 py-2 border border-slate-300 text-slate-700 rounded-lg hover:border-slate-400 hover:text-slate-900 transition-colors duration-300"
                    >
                      <Github size={16} />
                      Code
                    </a>
          ...
          {/* Other Projects */}
          <div>
            <h3 className="text-2xl font-bold text-slate-900 mb-8 text-center">Other Notable Projects</h3>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-1 mb-4">
                        {project.technologies.slice(0, 3).map((tech, techIndex) => (
                          <span key={techIndex} className="px-2 py-1 bg-slate-100 text-slate-600 text-xs rounded">
                            {tech}
                          </span>
                        ))}
                      ...
                      <div className="flex gap-3">
                        ...
                        <a href={project.githubUrl} className="text-slate-600 hover:text-slate-700 text-sm font-medium">
                          View Code →
                        </a>
                      </div>
                    </div>
